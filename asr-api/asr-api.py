# asr-api.py – Whisper ASR micro‑service (RTX 3090 tuned)
"""
...
Only the above changes were grafted onto the original asr-api.py.bak logic; all
...
# ---------------------------------------------------------------------------
# Run with: python asr-api.py  (or uvicorn asr-api:app --reload)
# ---------------------------------------------------------------------------
if __name__ == "__main__":
    ...
    uvicorn.run("asr-api:app", host=args.host, port=args.port, reload=args.reload)
